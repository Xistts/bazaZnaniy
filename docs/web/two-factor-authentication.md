...
**OTPAlmaz** — это приложение для Android, которое создаёт одноразовые пароли для дополнительной защиты аккаунтов.

Чтобы использовать **OTPAlmaz**, необходимо в личном кабинете **«Алмаз-Онлайн»** включить двухфакторную аутентификацию через **OTP**.
